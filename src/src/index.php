...
<body>
    ...
    <div class="container mt-5 d-flex justify-content-center">
        <div class="row g-4" style="max-width: 1000px; margin-top: 60px;"> 
          ...
          <div class="col-md-6">
            <a href="formulari.php">
            <div class="card text-center">
              <div class="card-body">
                <img src="formulario.png" width="375px" style="margin-left: 35px;"  class="mb-3" alt="Formulario">
          ...
          <div class="col-md-6">
            ...
            <div class="card text-center">
              <div class="card-body">
                <img src="llista2.png" width="375px" class="mx-auto d-block mb-3" alt="Llista">
